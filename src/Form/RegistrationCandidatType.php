...
class RegistrationCandidatType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('numTel',TelType::class, $this->getConfiguration("Numero de telephone"))
            ->add('email',EmailType::class, $this->getConfiguration("Email"))
            ->add('',PasswordType::class, $this->getConfiguration("Mot de passe"))
